...
public class DiscoverRule<TSelector, TDiscoverResult>
{
    #region [c-tor]
    /// <summary>
    ...
    /// </param>
    public DiscoverRule([NotNull] Func<TSelector, bool> canLoad, Func<TSelector, Task<TDiscoverResult>> tryLoad)
    {
        CanLoad = canLoad;
        TryLoad = tryLoad;
    }
    ...
    /// </summary>
    [NotNull]
    public Func<TSelector, Task<TDiscoverResult>> TryLoad { get; }
    #endregion
    #endregion
}